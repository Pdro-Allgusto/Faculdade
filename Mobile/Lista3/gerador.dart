...
void main() {
  ...
  List nomes = ["Bruno Assis","Cosme Pimenta","Elias Arouca","Eudes Quiroga","Filena Toledo","Lopo Trist","Luzia Rosa","Nestor Marmou","Reginaldo Meneses","Sofia Delgado"];
