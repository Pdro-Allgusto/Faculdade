...
/*
    public Object clonarPilha() {
        Ordenacao.pilhaEstatica temPilha = new Ordenacao.pilhaEstatica();
        Ordenacao.pilhaEstatica clone = new Ordenacao.pilhaEstatica();
...
*/
    public void aumentarCapacidadePilha(int capacidade) {
        ...
        if (this.tamanho() == itemArray.length) {
            arrayMaior = new Object[capacidade];
            for (int i = 0; i < this.itemArray.length; i++) {
                arrayMaior[i] = this.itemArray[i];
            }
            this.itemArray = arrayMaior;
        }
    }
}
