...
public class WritePessoaTel {
    public static void main(String[] args) throws IOException {
        ...
        // PessoaComTelefone[] vetor = consoleReadPessoaTel(numElem);

        // Le vetor de objetos já criados da classe PessoaComTelefone
        PessoaComTelefone[] vetor = readVetorPessoaTel();
    ...
    private static PessoaComTelefone[] readVetorPessoaTel() {
    ...
    private static PessoaComTelefone[] consoleReadPessoaTel(int numElem)
            throws IOException {
